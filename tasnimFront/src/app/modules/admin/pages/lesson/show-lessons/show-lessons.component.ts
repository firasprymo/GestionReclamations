...
export class ShowLessonsComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        // Get the pagination
        this._lessonService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    ...
                    this.closeDetails();
                    this.isLoading = true;
                    return this._lessonService.getAllLessons(0, 10, 'name', 'asc', query);
                }),
                map(() => {
        ...
        if (this._sort && this._paginator) {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() => {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._lessonService.getAllLessons(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                }),
                map(() => {
                    this.isLoading = false;
                })
